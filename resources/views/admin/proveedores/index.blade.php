  ...
  <div class="container-fluid">
    ...
    <div class="row mb-3 align-items-center">
      <div class="col-12">
        ...
        <p class="text-muted mb-0">Se muestra los proveedores registrados dentro
          del sistema.</p>
      </div>
    </div>
    ...
    <div class="row mb-3">
      <div class="col-12">
        <button class="btn btn-primary px-4 shadow-sm" data-toggle="collapse"
          data-target="#formProveedor">
    ...
    <div class="card shadow-sm border-0">
      <div class="card-body">
        ...
        <div
          ...
          <div
            class="d-flex flex-column flex-sm-row align-items-center mb-3 mb-md-0">

            {{-- BUSCADOR --}}
            <div
              class="form-group mb-2 mb-sm-0 mr-sm-3 d-flex align-items-center">
            ...
            <div class="dropdown mb-3 mb-sm-0 mr-sm-3">
              <button id="btnExportarProveedores"
                class="btn btn-default dropdown-toggle" type="button"
                data-toggle="dropdown">
                <i class="fas fa-download"></i> Exportar
              </button>
              <div class="dropdown-menu shadow border-0">
                <a href="" id="exportProveedoresExcel"
                  class="dropdown-item" data-export='excel'>
                  <i class="fas fa-file-excel text-success mr-1"></i> Excel
                </a>
                <a href="" id="exportProveedoresPdf" class="dropdown-item"
                  data-export='pdf'>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="modalEditarProveedorLabel">Editar Proveedor
        </h5>
  ...
  <script>
    $(function() {
      ...
      $('#exportProveedoresPdf').on('click', function(e) {
        e.preventDefault();
        window.open('{{ route('admin.proveedores.export-pdf') }}',
          '_blank');
      });
      ...
      $('#exportProveedoresExcel').on('click', function(e) {
        ...
        window.location.href =
          '{{ route('admin.proveedores.export-excel') }}';
      });
  ...
  <script>
    ...
    $(document).on('click', '#btnAddDireccion', function(e) {
      ...
      if ($container.length === 0) {
        $container = $(this).closest('.d-flex').nextAll(
          '#direcciones-container').first();
      }

      if ($container.length === 0) {
        $container = $(this).closest('.col-md-12').siblings(
